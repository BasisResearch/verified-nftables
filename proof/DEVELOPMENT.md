...
| `theories/Generated/` | `nft2coq` output (`*_Gen.v`, regenerated by `make gen`) — parser-emitted ASTs the Examples reason about |
...
| `theories/Generated/Optiplex_Gen.v` `Ruleset_Gen.v` `Router_Gen.v` `Tutorial_Gen.v` | **generated** by `nft2coq` from the matching `../rulesets/*.nft` (`make gen`; the parser's output as Coq terms, kernel-checked). `Tutorial_Gen.v` backs the [`CONFIG_PROOFS.md`](CONFIG_PROOFS.md) tutorial |
