...
Definition out_sport (e : env) (p : packet) : data :=
  slice (pkt_th (snd (snd (eval_chain Hprerouting dnat_port_chain e p)))) 0 2.
Definition out_dport (e : env) (p : packet) : data :=
  slice (pkt_th (snd (snd (eval_chain Hprerouting dnat_port_chain e p)))) 2 2.
...
Definition env_after_fwd_p : env :=
  fst (snd (eval_chain Hprerouting dnat_port_chain env0 fwd_p)).
