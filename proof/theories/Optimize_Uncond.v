...
Proof.
  ...
  pose proof (optimize_chain_vmapNg_fresh_vmapname nIg dIg cIg nVg dVg cVg EVg HfvIg) as HfvVg.
  pose proof (optimize_chain_vmapNg_output_vmap_fresh nIg dIg cIg nVg dVg cVg EVg HrvIg) as HrvVg.
  rewrite (optimize_chain_vmapN_correct_uncond nVg dVg cVg n' d' c' base p H HfvVg HrvVg).
  rewrite (optimize_chain_vmapNg_correct_uncond nIg dIg cIg nVg dVg cVg base p EVg HfvIg HrvIg).
