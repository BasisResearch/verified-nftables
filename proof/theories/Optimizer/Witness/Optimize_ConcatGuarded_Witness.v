(** Fires-witness for the guarded transport-key concat merge (Optimize_ConcatGuarded): two adjacent
...
From Nft Require Import Bytes Packet Verdict Syntax Bytecode Semantics
  Compile Optimize Optimize_ValueSet Optimize_Concat Optimize_ConcatGuarded.
...
Definition concatm_output :=
  optimize_rules_concatguarded (List.length concatm_input) 0 empty_decls concatm_input.
