(** Fires-witness for the interval / range set consolidation (Optimize_IntervalSet).  Two adjacent
...
From Nft Require Import Bytes Packet Verdict Syntax Bytecode Semantics
  Compile Optimize Optimize_ValueSet Optimize_IntervalSet Optimize_Table Optimize_Normalize
  Optimize_Uncond.
...
Definition ivset_output :=
  optimize_rules_intervalset (List.length ivset_input) 0 empty_decls' ivset_input.
