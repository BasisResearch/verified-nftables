(** Fires-witness for the GUARDED interval / range set consolidation
    ([Optimize_IntervalSetGuarded]).  Two `tcp dport <lo>-<hi> accept` rules — each lowered to a
...
From Nft Require Import Bytes Packet Verdict Syntax Bytecode Semantics
  Compile Optimize Optimize_ValueSet Optimize_SetGuarded Optimize_IntervalSetGuarded Optimize_Table
...
Definition ivsetg_output :=
  optimize_rules_intervalsetguarded (List.length ivsetg_input) 0 empty_decls' ivsetg_input.
...
Definition ivsetg_overlap_output :=
  optimize_rules_intervalsetguarded (List.length ivsetg_overlap_input) 0 empty_decls' ivsetg_overlap_input.
