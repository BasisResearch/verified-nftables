(** Fires-witness for the guarded value+verdict -> VERDICT MAP merge (battery shape
    ...
    verdict-register map).  This shows [optimize_rules_vmapguarded] fires NON-VACUOUSLY. *)
...
Definition vmapg_output :=
  optimize_rules_vmapguarded (List.length vmapg_input) 0 empty_decls vmapg_input.
