(** Fires-witness for the L2 link-layer single-field value->set consolidation
    ([Optimize_SetGuarded], L2 arm — [guard_okl2]).  Two `ether saddr <mac> accept` rules —
...
From Nft Require Import Bytes Packet Verdict Syntax Bytecode Semantics
  Compile Optimize Optimize_ValueSet Optimize_ConcatGuarded Optimize_SetGuarded Optimize_Table
...
Definition setl2_output :=
  optimize_rules_setguarded (List.length setl2_input) 0 empty_declsL2 setl2_input.
